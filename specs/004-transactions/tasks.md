...
- [ ] **MNT-218** [T][S] `GET /dashboard/view` — endpoint dedicado que agrega tudo que o dashboard `/` precisa numa resposta só. Novo módulo `api/src/dashboard/` (leve, sem entities próprias — orquestra services de accounts + transactions + card-billing). Shape resposta:
