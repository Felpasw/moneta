...
| `/charts` (MNT-91) | 007-visualizations | Aba Insights |
...
- [ ] **MNT-105** [S] Insights `/charts` (aba **Insights**) — **já implementado em MNT-91** (`specs/007-visualizations`). Aqui só entra o link da tab
