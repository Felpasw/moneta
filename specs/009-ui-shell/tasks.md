...
- [ ] **MNT-102** [T][S] Transações `/transactions` (aba **Grana**):
  ...
  - [ ] Web infra: `transactionsService` + `useTransactions` (Suspense pattern) — próximo bundle
  - [ ] Web consumer: `TransactionsScreen` real (lista agrupada por dia via render, empty state, cards com signedAmount colorido) — bundle seguinte
