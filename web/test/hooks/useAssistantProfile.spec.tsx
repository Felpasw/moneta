...
describe("assistantProfileHooks.use()", () => {
  ...
  describe("profile", () => {
    it("fetcha e cacheia o profile na query key correta", async () => {
      ...
      expect(queryClient.getQueryData(ASSISTANT_PROFILE_QUERY_KEYS.profile)).toEqual(
        PROFILE,
      );
    });
  });
  ...
  describe("voices", () => {
    it("fetcha e cacheia a lista de vozes", async () => {
      mockedService.getProfile.mockResolvedValueOnce(PROFILE);
