    ...
    <AnimatePresence>
      {open ? (
        <motion.aside
          ...
          className="fixed bottom-52 left-1/2 z-50 w-[min(320px,calc(100vw-2rem))] -translate-x-1/2 overflow-hidden rounded-2xl bg-neutral-900 text-neutral-50 shadow-2xl ring-1 ring-white/10"
        >
